...
export default function DashboardFilters({ grado, seccion, total, onGradoChange, onSeccionChange, dataFiltrada, nivel = "primaria" }: Props) {
      ...
      <div className="flex flex-wrap items-end gap-4">
        ...
        <div className="space-y-2">
          ...
          >
            {esInicial ? (
              <>
                <option value="todos" className="bg-slate-900">Todos (Inicial)</option>
        ...
        {/* Botón Exportar: en Inicial usa el reporte simple, en Primaria usa el general */}
        <button
          onClick={() => esInicial ? exportarDashboardInicialExcel(dataFiltrada) : exportarDashboardExcel(dataFiltrada)}
